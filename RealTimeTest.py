...
def main():
    ...
    parser.add_argument('--conf_threshold', type=float, default=80.0, help="Ngưỡng độ tin cậy (%)")
    ...
    last_predict_time = 0
    predict_interval = 0.3  # Nhận diện mỗi 0.3 giây
    label_text = "Dang quet..."
    conf_text = ""
    box_color = (0, 255, 0)  # Mặc định xanh lá
