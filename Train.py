...
if __name__ == "__main__":
    ...
    datasetpath=[
        PROJECT_ROOT /"data/German51K/German_51k",
        PROJECT_ROOT / "data/BelgiumTSC/Belgium_TSC",
        PROJECT_ROOT /"data/German51K/german-trafic-sign",

        PROJECT_ROOT /"data/German51K/German_51k_new_1",
        PROJECT_ROOT /"data/German51K/German_51k_new_2",
        PROJECT_ROOT /"data/German51K/German_51k_new_3",
        PROJECT_ROOT /"data/BelgiumTSC/belgium_ar_new_1",
        PROJECT_ROOT /"data/BelgiumTSC/belgium_ar_new_2",
        PROJECT_ROOT /"data/BelgiumTSC/belgium_ar_new_3"
    ]
    args = get_args()
    ...
    for i in range (0,12):
        for j in range(1,9):
            ...
            args.__setattr__("dataset_name", datasetname[j])
            args.__setattr__("root_dataset_path", datasetpath[j])
            args.__setattr__("batch_size", 64)
            args.__setattr__("img_size", 32)
            args.__setattr__("num_epoch", 1)
            ...
            train_loader, val_loader, test_loader, num_classes = dataloader_prepare(
                ...
                seed=args.SEED,
                save_path=os.path.join(args.save_path, "_dataset_splits"),
                logger=logger
            )
