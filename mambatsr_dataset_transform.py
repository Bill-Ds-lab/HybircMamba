...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Tạo Dataset với các phép biến đổi")

    parser.add_argument(
        '--input_dir',
        type=str,
        default=str(PROJECT_ROOT / "data" / "German51K"/"German_51k"),
        choices=(str(PROJECT_ROOT/ "data" /"BelgiumTSC"/"Belgium_TSC"),
                str(PROJECT_ROOT / "data" / "German51K" / "German_51k")),
        help='Thư mục dataset gốc'
    )
    parser.add_argument(
        '--output_dir',
        type=str,
        default=str(PROJECT_ROOT / "data" / "German51K"/"German_51k_new_1"),
        choices=(str(PROJECT_ROOT / "data" / "German51K"/"German_51k_new_1"),
                 str(PROJECT_ROOT / "data" / "German51K"/"German_51k_new_2"),
                 str(PROJECT_ROOT / "data" / "German51K"/"German_51k_new_3"),
                 str(PROJECT_ROOT / "data" / "BelgiumTSC"/"belgium_ar_new_1"),
                 str(PROJECT_ROOT / "data" / "BelgiumTSC"/"belgium_ar_new_2"),
                 str(PROJECT_ROOT / "data" / "BelgiumTSC"/"belgium_ar_new_3")),
    ...
    parser.add_argument('--type', type=str, default='rain_w2')
